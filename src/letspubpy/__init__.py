...
__all__.extend([
    ...
    'sim_volcano_data', 'ggvolcano', 'visVolcano',
    'sim_raincloud_data', 'ggraincloud', 'visRaincloud',
    'sim_survival_data', 'ggsurvplot', 'visSurvival',
    'sim_forest_data', 'ggforest', 'visForest',
    'sim_roc_data', 'ggroc', 'visROC',
    'sim_doseresponse_data', 'ggdoseresponse', 'ggic50', 'visDoseResponse',
    'sim_waterfall_data', 'ggwaterfall', 'visWaterfall',
    'sim_gwas_data', 'ggmanhattan', 'visManhattan',
    'sim_blandaltman_data', 'ggblandaltman', 'visBlandAltman',
    'sim_radar_data', 'ggradar', 'visRadar',
    'sim_upset_data', 'ggupset', 'visUpSet',
    'rremove', 'ggpar',
